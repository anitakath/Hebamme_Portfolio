          ...
          <div className={styles.sectionContainer}>
            <div className={styles.aboutMeTextContainer}>
              ...
              <p className={styles.paragraph}>
                ...
                Bedürfnissen der Frauen basiert, eine positive Auswirkung auf
                das Geburtserlebnis und die postnatale Zeit haben kann. Indem
                wir gemeinsam arbeiten, können wir eine vertrauensvolle
                Beziehung aufbauen und einen Raum schaffen, in dem Du Dich
                sicher, unterstützt und respektiert fühlst. <br />
                <br />
            ...
            <div className={styles.aboutMeTextContainer}>
              ...
              <p className={styles.paragraph}>
                ...
                und Fähigkeiten in der Geburtshilfe zu vertiefen und mich auf
                die professionelle Betreuung von Müttern und ihren Neugeborenen
                zu spezialisieren. Während meiner Ausbildung habe ich ein
                fundiertes Verständnis für die medizinischen Aspekte der
                Schwangerschaft und Geburt erworben sowie für die Bedeutung
                einer einfühlsamen und ganzheitlichen Betreuung. <br /> <br />
                ...
                Forschung. Durch mein Studium konnte ich mich auch intensiv mit
                aktuellen wissenschaftlichen Erkenntnissen und Best Practices in
                der Hebammenarbeit auseinandersetzen. <br />
              </p>
            </div>
          </div>
